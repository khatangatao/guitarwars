...
<head>
  ...
  <title>Гитарные войны. Модерирование рейтинга</title>
  <link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
  <h2>Гитарные войны. Модерирование рейтинга</h2>
...
if (isset($_POST['submit'])) {
	if ($_POST['confirm'] == 'yes') {
		...
		//Модерирование рейтинга путем установки значения 1 для колонки approved
		$query = "UPDATE guitarwars SET approved=1 WHERE id = '$id'";
		mysqli_query($dbc, $query);
		mysqli_close($dbc);

		//Вывод пользователю страницы подтверждения
		echo '<p>Рейтинг ' . $score . 'для пользователя ' . $name . ' был успешно санкцонирован.</p>';

	} else {
		echo '<p class="error">Извините, возникли проблемы с санкционированием рейтинга';
	}
...
echo '<p><a href="admin.php">&lt;&lt; Назад к странице администрирования </a></p>';
?>
